...
check_cxx_symbol_exists(strcasecmp "strings.h" HAVE_STRINGS)
check_cxx_symbol_exists(localtime_r "strings.h" HAVE_LOCALTIME_R)
...
if (RCT_BUILD_SCRIPTENGINE)
  ...
  if (V8_FOUND STREQUAL "YES")
      ...
      message(STATUS "Building ScriptEngine")
      set(RCT_SOURCES ${RCT_SOURCES} ${CMAKE_CURRENT_LIST_DIR}/rct/ScriptEngine.cpp)
      list(APPEND RCT_INCLUDE_DIRS ${V8_INCLUDE_DIR} ${V8_INCLUDE_DIR}/..)
      list(APPEND RCT_LIBRARIES ${V8_LIBRARY})
  else ()
      message(FATAL_ERROR "Can't find v8")
  endif ()
endif ()
